...
export default function LandMapUnified() {
  ...
  return (
    <>
      <div className="flex min-h-[calc(100dvh-7rem)] md:h-[calc(100vh-8rem)] flex-col gap-4 rounded-2xl border border-theme bg-theme-card overflow-hidden md:flex-row">
        {/* Left panel */}
        <div
          className={`flex shrink-0 flex-col border-theme bg-theme-track md:w-[340px] md:border-r ${panelOpen ? "block" : "hidden md:block md:w-14"
            }`}
        >
          <button
            type="button"
              ...
              <div className="flex flex-wrap gap-1 rounded-lg bg-theme-card p-1">
                {tabs.map((tab) => (
                  <button
                    ...
                    className={`flex items-center gap-1.5 rounded-md px-2.5 py-2 text-sm font-medium transition-colors ${addTab === tab.id
                ...
                <>
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className={`flex-1 rounded-xl py-2.5 text-sm font-medium ${drawShape === "polygon"
                          ? "bg-green-500/30 text-green-400"
                    ...
                    <button
                      ...
                      className={`flex-1 rounded-xl py-2.5 text-sm font-medium ${drawShape === "rectangle"
                          ? "bg-green-500/30 text-green-400"
                          : "border border-theme text-theme-muted hover:text-theme"
                        }`}
                    >
          ...
          <div className="absolute right-3 top-3 z-[1000] flex flex-col gap-2">
            ...
            <div className="flex items-center gap-1 rounded-2xl border border-white/20 bg-black/70 p-1.5 shadow-xl backdrop-blur-md">
              {MAP_LAYERS.map((layer) => (
                <button
                  ...
                  className={`flex items-center gap-1 rounded-xl px-3 py-2 text-xs font-medium transition-colors ${viewMode === layer.id
            ...
            <div className="flex items-center gap-1 rounded-2xl border border-white/20 bg-black/70 p-1.5 shadow-xl backdrop-blur-md">
              ...
              <button
                ...
                className={`rounded-xl p-2 ${drawActive
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-5">
              ...
              <div className="flex flex-col gap-2 pt-2">
                ...
                <button
                  ...
                  disabled={deleting}
                  className={`flex items-center justify-center gap-2 rounded-xl py-2.5 text-sm font-medium ${deleteConfirm
